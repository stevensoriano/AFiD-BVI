!===========================================
      subroutine PackZ_UnpackR_C(aa,bb)
      use mpih
      use mpi_param
      use param, only: n2m,n3m,n2,n3,n1
      implicit none
      complex, intent(in) :: aa(1:n1,1:n2,kstart:kend)
      complex, intent(out) :: bb(1:n3,1:n1,jstart:jend)
      ...
      do kk = 0, numtasks-1
        ...
        enddo
      enddo
      call MPI_ALLTOALLV(sbuf, aaj,dispj, MCP, &
                        rbuf, aak,dispk, MCP, &
                        MPI_COMM_WORLD, ierr)
      ...
      end subroutine PackZ_UnpackR_C
 
!============================================
      subroutine PackR_UnpackZ_C(aa,bb)
      use mpih
      use mpi_param
      use param, only: n2m,n3m,n2,n3,n1
      implicit none
      complex, intent(in) :: aa(1:n3,1:n1,jstart:jend)
      complex, intent(out) :: bb(1:n1,1:n2,kstart:kend)
      complex, allocatable :: sbuf(:),rbuf(:)
      integer, allocatable :: aaj(:), aak(:)
      integer, allocatable :: dispj(:), dispk(:) 
      integer :: dr,dz,offsetr,offsetz
      ...
      end subroutine PackR_UnpackZ_C
!===========================================
